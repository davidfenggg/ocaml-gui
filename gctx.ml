...
(* Gets the red integer of the color *)
let get_red (c: color) : int =
  c.r

(* Gets the green integer of the color *)
let get_green (c: color) : int =
  c.g

(* Gets the blue integer of the color *)
let get_blue (c: color) : int =
  c.b 

(* Creates a new Gctx.t with a new thickness *)
