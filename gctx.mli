...
(* Get the red int from the color *)
val get_red : color -> int

(* Get the green int from the color *)
val get_green : color -> int

(* Get the blue int from the color *)
val get_blue : color -> int

(** Produce a new gctx wiht a different thickness *)
...
val draw_ellipse : gctx -> position -> position -> unit  
